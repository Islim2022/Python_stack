...
class User(models.Model):
    ...
    objects = UserManager()
    # messages = a list of messages associated with the given user.
    # comments = a list of comments associated with the given user.
...
class Message(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    # comments = a list of comments associated with the provided message.
